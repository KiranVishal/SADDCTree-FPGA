...
void ControlUnit_api_t::init_sim_data (  ) {
  ...
  sim_data.inputs.push_back(new dat_api<32>(&mod->ControlUnit__io_n_node));
  sim_data.inputs.push_back(new dat_api<32>(&mod->ControlUnit__io_leaf_node));
  sim_data.inputs.push_back(new dat_api<32>(&mod->ControlUnit__io_nonleaf_node));
  sim_data.inputs.push_back(new dat_api<32>(&mod->ControlUnit__io_current_node));
  sim_data.inputs.push_back(new dat_api<32>(&mod->ControlUnit__io_left_node));
  sim_data.inputs.push_back(new dat_api<32>(&mod->ControlUnit__io_right_node));
  sim_data.inputs.push_back(new dat_api<32>(&mod->ControlUnit__io_feature_index));
  sim_data.inputs.push_back(new dat_api<32>(&mod->ControlUnit__io_optN_comp));
