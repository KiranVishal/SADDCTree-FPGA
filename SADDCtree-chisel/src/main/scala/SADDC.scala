...
case object No_Comparator extends Field[Int]
// case object No_Nodes extends Field[Int]
// case object No_Leaf extends Field[Int]
...
abstract trait SADDCParameters extends UsesParameters {
	val n_comparator = params(No_Comparator) 
	// val n_node = params(No_Nodes)
	// val n_leaf = params(No_Leaf)
