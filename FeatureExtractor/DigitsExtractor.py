...
feature_writer = csv.writer(open('./FeatureExtractor/FE_Digits.csv','w'),delimiter=' ', quotechar='|')
...
import pydotplus
dot_data = DT_Visualizer.getDotFile(estimator=estimator, target_names=str(digits.target_names))

graph = pydotplus.graph_from_dot_data(dot_data.getvalue())
graph.write_pdf("./DecisionTreeVisualizer/digits.pdf")
